...
function load_generators_data!(setup::Dict, path::AbstractString, inputs_gen::Dict, fuel_costs::Dict, fuel_CO2::Dict)
	...
	# Set of existing natural gas cc and turbine resources
	#inputs_gen["ngcc_existing"] = gen_in[gen_in.Existing_NGCC.>=1,:R_ID]
	#inputs_gen["ngt_existing"] = gen_in[gen_in.Existing_NGT.>=1,:R_ID]

	#potential zero carbon fuel retrofit generators
	#inputs_gen["ngcc_retro"] = gen_in[gen_in.Retro_NGCC.>=1,:R_ID]
	#inputs_gen["ngt_retro"] = gen_in[gen_in.Retro_NGT.>=1,:R_ID]
