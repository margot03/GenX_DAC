...
function generate_model(setup::Dict,inputs::Dict,OPTIMIZER::MOI.OptimizerWithAttributes)
	...
	#@objective(EP,Min,EP[:eEmissionsPowerPlants])
	...
	#new constraint on total system cost
	#@constraint(EP, cCostObjectiveMax , EP[:eObj]  <= 13699358067.5375*1.0001)  ## hp power cost - 13699358067.5375  lp cost - 13667762670.4777, no dac cost - 12769785440, 
	#@constraint(EP, cCostObjectiveMin , EP[:eObj]  >= 13699358067.5375*0.9999)
